...
##
## Debug
ProjectName            :=timer_list_cpp
ConfigurationName      :=Debug
WorkspacePath          := "E:\data\example"
ProjectPath            := "E:\data\example\timer_list_cpp"
...
ObjectsFileList        :="timer_list_cpp.txt"
PCHCompileFlags        :=
...
Objects0=$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IntermediateDirectory)/timer.cc$(ObjectSuffix) 
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "E:/data/example/timer_list_cpp/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/timer.cc$(ObjectSuffix): timer.cc $(IntermediateDirectory)/timer.cc$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "E:/data/example/timer_list_cpp/timer.cc" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/timer.cc$(ObjectSuffix) $(IncludePath)
