...
##
## Debug
ProjectName            :=attribute_nonnull
ConfigurationName      :=Debug
WorkspacePath          := "E:\data\example2\example2"
ProjectPath            := "E:\data\example\attribute_nonnull"
...
ObjectsFileList        :="attribute_nonnull.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main.c$(ObjectSuffix): main.c $(IntermediateDirectory)/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/data/example/attribute_nonnull/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
...
clean:
	...
	$(RM) $(OutputFile)
	$(RM) $(OutputFile).exe
	$(RM) "../../example2/example2/.build-debug/attribute_nonnull"
