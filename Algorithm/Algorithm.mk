...
clean:
	...
	$(RM) $(IntermediateDirectory)/algorithm$(ObjectSuffix)
	$(RM) $(IntermediateDirectory)/algorithm$(DependSuffix)
	$(RM) $(IntermediateDirectory)/algorithm$(PreprocessSuffix)
	$(RM) $(OutputFile)
	$(RM) $(OutputFile).exe
	$(RM) "../.build-debug/Algorithm"
